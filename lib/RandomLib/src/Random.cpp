...
RCSID_DECL(RANDOMLIB_RANDOM_CPP)
RCSID_DECL(RANDOMLIB_RANDOMTYPE_HPP)
RCSID_DECL(RANDOMLIB_RANDOMSEED_HPP)
RCSID_DECL(RANDOMLIB_RANDOMENGINE_HPP)
RCSID_DECL(RANDOMLIB_RANDOMMIXER_HPP)
RCSID_DECL(RANDOMLIB_RANDOMALGORITHM_HPP)
RCSID_DECL(RANDOMLIB_RANDOMPOWER2_HPP)
RCSID_DECL(RANDOMLIB_RANDOMCANONICAL_HPP)
